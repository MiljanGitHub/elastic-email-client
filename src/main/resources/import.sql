...
INSERT INTO email_project.account ( smtp_address, smtp_port, inserver_type, inserver_address, inserver_port, authentication, username, password, display_name, bucket, user_id) VALUES ('smtp.gmail.com', 587, 1, 'imap.gmail.com', 993, 1, 'testingjavamailsend@gmail.com', 'testsend123', 'Gmail account', 'user-1-bucket', 1);
